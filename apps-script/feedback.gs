 ...
 *   3. על דיווח תקלה - שולח מייל התראה מיידי לאמנון (NOTIFY_EMAIL) עם כל הפרטים.
 *
...
// יעד מייל ההתראה על דיווחי תקלה (המשובים לא שולחים מייל, רק נכתבים לגיליון).
// הגיליון נשאר בדרייב של gergrood; ההתראות נשלחות אל אמנון (בקשת נופר).
var NOTIFY_EMAIL = 'amnon.herman@gmail.com';
...
/** מייל התראה מיידי על דיווח תקלה (ל-NOTIFY_EMAIL), כולל לינקים ללשוניות התקלות והמשובים. */
